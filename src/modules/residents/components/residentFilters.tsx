...
export function ResidentFilters({ params, buildings, onChange }: ResidentFiltersProps) {
  return (
    <Row gutter={[12, 12]} align='middle'>
      {/* Qidiruv — mobilda to'liq, desktopda keng */}
      ...
      <Col xs={24} sm={12} md={6} lg={7}>
        <Select
          ...
          onChange={(val) => onChange({ building_id: val ?? undefined, page: 1 })}
          allowClear
          style={{ width: '100%' }}
        >
          {buildings.map((b) => (
