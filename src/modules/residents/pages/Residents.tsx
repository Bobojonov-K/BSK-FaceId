...
import { Building } from '@/modules/buildings/types/building';
...
const STATUS_LABELS: Record<
  string,
  { title: string; content: (name: string) => string; okText: string; danger?: boolean }
> = {
  active: {
...
export function ResidentsPage() {
  ...
  const updateParams = useCallback(
    (updated: Partial<ResidentsQueryParams>) => setParams((prev) => ({ ...prev, ...updated })),
    [],
  );
